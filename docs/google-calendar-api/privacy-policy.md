...
**การอัปเดตอัตโนมัติ (opt-in):** หากผู้ใช้เปิดใช้ "อัปเดตอัตโนมัติ" ระบบจะตั้งงานเบื้องหลัง (ในบัญชีของผู้ใช้เอง) ที่อ่าน**เฉพาะรายการเวรของผู้ใช้คนนั้น**จากฐานข้อมูลตารางเวรของระบบเป็นระยะ (ทุกไม่กี่นาที) เพื่อให้ปฏิทินตรงกับเวรล่าสุดแม้ไม่ได้เปิดแอป — อ่านอย่างเดียว ไม่อ่านข้อมูลของผู้อื่น และปิดได้ตลอดเวลา
